...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Brand (45%) */}
      <div className="hidden lg:flex lg:w-[45%] bg-brand text-white flex-col justify-between p-12 relative overflow-hidden">
      ...
      <div className="w-full lg:w-[55%] bg-white flex flex-col">
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-16 xl:px-24 py-12">
          ...
          <form className="space-y-5 max-w-sm mx-auto w-full">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-brand hover:bg-brand-dark text-white font-medium rounded-full transition-all shadow-green hover:shadow-green"
            >
              Sign In
            </Button>
          </form>
