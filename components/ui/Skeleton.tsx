...
export function SkeletonPage({ title = true, cards = 0, tableRows = 8, tableCols = 5 }: {
  title?:      boolean;
  cards?:      number;
  tableRows?:  number;
  tableCols?:  number;
  ...
  return (
    <div>
      ...
      {cards > 0 && (
        <div style={{ display: "grid", gridTemplateColumns: `repeat(${cards}, 1fr)`, gap: 12, marginBottom: 20 }}>
